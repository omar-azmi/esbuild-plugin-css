...
`,a.map(t=>{let{path:s,contents:i}=t;return{path:s,size:i.length}})),l.initialOptions.write!==!1?Promise.all(a.map(t=>(0&&console.log("writing to:",t.path),Deno.writeFile(t.path,t.contents)))):(n.outputFiles??=[],n.outputFiles.push(...a)))})}}};})();
